...
create policy "photo_reactions_insert_own" on photo_reactions for insert with check (true);
create policy "photo_reactions_delete_own" on photo_reactions for delete using (true);
